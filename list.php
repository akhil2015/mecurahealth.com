...
if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $myusername = $_POST["Specialist"];
      $sql = "SELECT * FROM doc WHERE specialisation = '$myusername'";
...
<body>
  ...
  <div class="container">
  <table class="table table-hover table-responsive data-toggle">
    <thead>
      <tr>
        <th>No</th>
        <th>Doctor</th>
    ...
    while ($row = mysqli_fetch_array($query))
    {
      ...
      echo '<tr>
          ...
          <td>'.$row['time']. '</td>
          <td><form method="POST" action="booking.php?id='. $row['did'].'"><button type="submit" class="btn btn-success">Book Now</button></form></td>
        </tr>';
      $no++;
    }?>
    </tbody>
