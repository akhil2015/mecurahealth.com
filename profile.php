...
<!-- nav bar -->
  <section class="sct-all container-fluid">
    <div class="navbar navbar-default nav-custom navbar-fixed-top animated fadeInDownBig">
  ...
  <section class="list">
   ...
   <?php
    ...
    while ($row = mysqli_fetch_array($query))
    {
      ...
      echo '<div class="col-md-3 animated rollIn" style="padding-bottom: 10px;">  
                <div class="card">
                  <br><h3>'.$row['doctor'].'</h3><br>
                  <p class="title">'.$row['specialisation'].'</p>
                  <p>'.$row['time'].'</p>
                  </div>
            </div>';
      if (($no/4)==0) {
